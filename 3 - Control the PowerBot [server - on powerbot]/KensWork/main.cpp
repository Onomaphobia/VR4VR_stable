...
int main(int argc, char** argv) {
	...
	// The hydra ratio input action
	
	HydraRatioInput hydraAction;

	// Action that requests motion based on abstract ratios
	ArActionRatioInput ratiodriveAction;
	...
	//pointer to the setratio function
	hydraAction.addRatioInput(&ratiodriveAction);
	...
	pbRobot.addAction(&ratiodriveAction, 3);
	pbRobot.addAction(&hydraAction, 2);
